...
const PERSONS = ["Nicolas", "Aylin", "Malia"];
...
const DEFAULT_INCOME = { einkuenfte1: 7400, einkuenfte2: 4850, zusatzeinkuenfte: 900 };

// Ausgangsstruktur je Kategorie, Werte aus "Aylin 60%". isFixed=true -> automatische monatl./jährl. Verrechnung.
const DEFAULT_CATEGORIES = {
  wohnen: { name: "Wohnen", positions: [
    { name: "Wohnungsmiete", amount: 2700, isFixed: true, type: "monthly", split: [] },
    { name: "Telefon", amount: 30, isFixed: true, type: "monthly", split: [] },
    { name: "Zweite Hypothek oder Miete", amount: 0, isFixed: false },
    { name: "Wasser- und Elektrizitätswerk", amount: 40, isFixed: false },
    { name: "TV + Internet", amount: 50, isFixed: false },
    { name: "Sonstiges", amount: 0, isFixed: false },
  ]},
  verkehr: { name: "Verkehrsmittel", positions: [
    { name: "Fahrzeugversicherung", amount: 200, isFixed: true, type: "monthly", split: [] },
    ...
    { name: "Kraftstoff", amount: 200, isFixed: false },
    { name: "Wartung", amount: 150, isFixed: false },
    { name: "Sonstiges", amount: 0, isFixed: false },
  ]},
  versicherung: { name: "Versicherung", positions: [
    { name: "Hausratversicherung", amount: 50, isFixed: true, type: "monthly", split: [] },
    { name: "Krankenversicherung", amount: 1020, isFixed: true, type: "monthly", split: [
      { person: "Nicolas", amount: 400 }, { person: "Aylin", amount: 400 }, { person: "Malia", amount: 220 },
    ] },
    { name: "Reiseversicherung", amount: 20, isFixed: true, type: "monthly", split: [] },
    { name: "Sonstige", amount: 0, isFixed: false },
  ]},
  essen: { name: "Essen", positions: [
    { name: "Lebensmittel", amount: 700, isFixed: false },
    { name: "Ausgehen", amount: 100, isFixed: false },
    { name: "Sonstige", amount: 0, isFixed: false },
  ]},
  kinder: { name: "Kinder", positions: [
    { name: "KITA-Kosten", amount: 640, isFixed: true, type: "monthly", split: [] },
    { name: "Arztkosten", amount: 75, isFixed: false },
    { name: "Kleidung", amount: 75, isFixed: false },
    ...
    { name: "Spielzeug/Spiele", amount: 30, isFixed: false },
    { name: "Sonstige", amount: 180, isFixed: false },
  ]},
  ...
  ersparnisse: { name: "Ersparnisse/Investitionen", positions: [
    { name: "Altersvorsorge", amount: 800, isFixed: true, type: "monthly", split: [] },
    { name: "Langzeit-Investition", amount: 800, isFixed: true, type: "monthly", split: [
      { person: "Nicolas", amount: 400 }, { person: "Aylin", amount: 400 },
    ] },
    { name: "Ferien", amount: 500, isFixed: false },
  ]},
  ...
  unterhaltung: { name: "Unterhaltung", positions: [
    { name: "Streaming-Apps", amount: 15, isFixed: false },
    { name: "Onlinespiele", amount: 0, isFixed: false },
    { name: "Filme", amount: 0, isFixed: false },
    { name: "Konzerte", amount: 0, isFixed: false },
    { name: "Sportveranstaltungen", amount: 200, isFixed: false },
    { name: "Theater", amount: 0, isFixed: false },
    { name: "Sonstige", amount: 50, isFixed: false },
  ]},
  steuern: { name: "Steuern", positions: [
    { name: "Kantons- + Bundessteuern", amount: 460, isFixed: false },
  ]},
  pflege: { name: "Persönliche Pflege", positions: [
    { name: "Sackgeld", amount: 1000, isFixed: true, type: "monthly", split: [
      { person: "Nicolas", amount: 500 }, { person: "Aylin", amount: 500 },
    ] },
    { name: "Arztkosten", amount: 75, isFixed: false },
    { name: "Haare/Nägel", amount: 40, isFixed: false },
  ...
  geschenke: { name: "Geschenke und Spenden", positions: [
    { name: "Spenden 1", amount: 40, isFixed: false },
...
@media(max-width:840px){
  ...
  .fb-main{ padding:16px 14px 88px; width:100%; }
  .fb-mobile-nav{ display:flex; position:fixed; bottom:0; left:0; right:0; background:var(--ink); padding:6px 2px; justify-content:space-around; z-index:50; }
  .fb-mobile-nav-item{ display:flex; flex-direction:column; align-items:center; gap:2px; color:rgba(255,255,255,.6); font-size:10px; cursor:pointer; flex:1; padding:6px 0; }
...
function Dashboard({ yearBudget, expenses, year, month, setMonth, goCategories, openExpenseModal }) {
...
function ExpenseModal({ yearBudget, defaultCategoryId, defaultPosition, lockCategory, lockPosition, onClose, onSave }) {
...
function PositionRow({ p, prevAmt, onUpdate, onToggleFixed, onRemove, onToggleMonth, onAddSplit, onUpdateSplit, onRemoveSplit }) {
  return (
...
function YearBudgetPage({ yearBudget, prevYearBudget, years, year, setYear, persistYearBudget, addYear }) {
        ...
        <div style={{ marginTop: "auto", paddingTop: 16, borderTop: "1px solid rgba(255,255,255,.12)" }}>
          ...
          {inviteCode && (
            <div style={{ fontSize: 11, color: "rgba(255,255,255,.55)", marginTop: 8 }}>
              Einladungscode<br />
              <span className="fb-mono" style={{ color: "#fff", fontSize: 13 }}>{inviteCode}</span>
            </div>
          )}
      ...
      <main className="fb-main">
        ...
        {view.name === "yearBudget" && (
          <YearBudgetPage yearBudget={yearBudget} prevYearBudget={prevYearBudget} years={years} year={year} setYear={setYear}
            persistYearBudget={persistYearBudget} addYear={addYear} />
        )}
      </main>
